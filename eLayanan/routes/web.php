...
*/
        ...
        Route::get('/print-menara/{id}', 'PostMenaraController@print');
        Route::get('/print-blank-menara/{id}', 'PostMenaraController@printblank');
/*
|--------------------------------------------------------------------------
...
*/
        ...
        Route::get('/print-fiber/{id}', 'PostFiberController@print');
        Route::get('/print-blank/{id}', 'PostFiberController@printblank');
/*
|--------------------------------------------------------------------------
...
*/
        ...
        Route::get('/printsurat/{id}', 'MenaraController@print');
        Route::get('/suratditolak/{id}', 'MenaraController@tolak');
/*
|--------------------------------------------------------------------------
| View - User Fiber
|--------------------------------------------------------------------------
*/
        ...
        Route::get('/fiber/userpdf/{id}', 'FiberController@exportPdf');
        ...
        Route::get('/fiber/printsurat/{id}', 'FiberController@print');
        Route::get('/fiber/suratditolak/{id}', 'FiberController@tolak');
    });
});
