...
@section('tittle', 'Surat Rekomendasi')
	...
	<table class="table-border">
		<tbody>
			<tr>
				...
				<td width="5">:</td>
				<td width="405"><p class="satu">{{ $fiber->nama_jaringan }}-01 s/d {{ $fiber->nama_jaringan }}-{{ $fiber->jml_tiang }}</p></td>
			</tr>
			<tr>
				<td width="50"></td>
			...
			<tr>
				...
				<td width="5">:</td>
				<td width="405"><p class="satu">({{ $fiber->titik_awal }}) s/d ({{ $fiber->titik_akhir }},  {{ $fiber->latitude }})</p></td>
			</tr>
			<tr>
				<td width="50"></td>
